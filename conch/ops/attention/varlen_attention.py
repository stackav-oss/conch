...
def _determine_max_num_kv_splits(max_seqlen_q: int, max_seqlen_k: int, max_num_blocks_per_sequence: int) -> int:
    ...
    # If we have all decodes, only enable FlashDecoding if we have a long sequence (>=8192 tokens) and
    ...
    if max_seqlen_q == 1 and max_seqlen_k >= 8192 and max_num_blocks_per_sequence >= 64:
