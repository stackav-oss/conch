...
def _scaled_gemm_vllm_ref(
    ...
    from vllm._custom_ops import cutlass_scaled_mm  # type: ignore[import-not-found]

    return cutlass_scaled_mm(a, b, scale_a, scale_b, out_dtype, bias)  # type: ignore[no-any-return]
