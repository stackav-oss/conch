...
from conch.ops.vision.quick_cumsum import quick_cumsum
from conch.platforms import current_platform
from conch.reference.vision.quick_cumsum import bev_pool
...
def test_bev_pool(
    ...
    geom_feats = torch.stack((geom_feats_b, geom_feats_z, geom_feats_x, geom_feats_y), dim=1)
