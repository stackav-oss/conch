...
def _create_paged_cache_from_contiguous_kv(
    ...
    for batch_index in range(batch_size):
        ...
        block_tables[batch_index] = torch.Tensor(current_blocks)
...
def _run_paged_vs_sdpa(
    ...
    key_cache_paged, value_cache_paged, block_tables = _create_paged_cache_from_contiguous_kv(
...
def _triton_vs_vllm_cuda(
    ...
    from vllm._custom_ops import (  # type: ignore[import-not-found, unused-ignore]  # isort:skip
...
def _triton_vs_flash_attn(
    ...
    from vllm.vllm_flash_attn import (  # type: ignore[import-not-found, unused-ignore]  # isort:skip
        flash_attn_with_kvcache,  # type: ignore[attr-defined, unused-ignore]
    )
