...
def main(  # noqa: PLR0913
    ...
    if enable_bnb:
        ...
        from bitsandbytes.functional import (  # type: ignore[import-not-found, unused-ignore]  # isort:skip
            dequantize_4bit as bnb_dequantize_4bit,  # type: ignore[import-untyped, unused-ignore]
        )
